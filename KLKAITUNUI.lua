...
Liber.setui = function(ll)
	...
	Windown.Size = UDim2.new(0.650000024, 0, 0, 0)
	...
	TweenService:Create(
		...
		{
			Size = UDim2.new(0.650000024, 0, 0.60000024, 0),
		}
	):Play()
	...
	NameHub.Text = _G.NameHub or "Normal Hub | Beta 0.09"
	...
	Liber.setPlayerLevel = function()
		...
		UIGradient.Color = ColorSequence.new{
			...
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(19, 221, 12)),
			ColorSequenceKeypoint.new(math.clamp(0.00, 0, 1), Color3.fromRGB(23, 74, 0)),
